CREATE TABLE IF NOT EXISTS analytics.`casino_payout`
(
    `id` String,
    ...
    `currency` String,
    `status` Int32,
    `paid_time` DateTime64(6, 'UTC'),
    `total_paid_amount` Nullable(Decimal(20,8)),
    `payout_tax1` Decimal(20,8),
    `payout_tax2` Decimal(20,8),
    `payout_tax3` Decimal(20,8),
